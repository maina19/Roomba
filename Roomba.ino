 ...
 *  
 * Written and directed by Luca Mainardi
 ******************************************************************************************/
/* Librerie *******************************************************************************/
...
#define SUB_FEED_NAME   "/feeds/***"      // Feed per il controllo
#define PUB_FEED_NAME   "/feeds/***"      // Feed per i dati
...
Adafruit_MQTT_Subscribe roombaSub = Adafruit_MQTT_Subscribe (&mqtt, AIO_USERNAME SUB_FEED_NAME);
Adafruit_MQTT_Publish   roombaPub = Adafruit_MQTT_Publish   (&mqtt, AIO_USERNAME PUB_FEED_NAME);
